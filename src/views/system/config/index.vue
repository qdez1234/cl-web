<template>
     ...
     <div class="container-right">
           ...
           <el-row :gutter="20" class="ex-form-row">
             ...
             <el-col :md="6">
               <el-form-item label="系统内置" prop="configType">
                 <el-select v-model="queryParams.configType" placeholder="系统内置" style="width: 100%" clearable
                   @change="handleQuery">
       ...
       <div class="ex-search">
         <el-form :model="queryParams" ref="queryForm" label-width="80px">
           <el-row :gutter="20" class="ex-form-row">
             <el-col :md="20">
               <el-button class="filter-item" v-hasPermi="['system:config:add']" type="primary" icon="Plus"
                 @click="handleAdd">新增</el-button>
               <el-button class="filter-item" v-hasPermi="['system:config:remove']" type="danger" icon="Delete"
                 @click="handleBatchDelete">删除</el-button>
               <el-button class="filter-item" v-hasPermi="['system:config:remove']" type="info" icon="Refresh"
       ...
       <div class="ex-table-page-body">
         <AgTable class="AgTable" ref="gridRef" @HandleCellClick="HandleCellClick" :paging="true"
           ...
           :grildUrl="gridAPI" gridRowKey="configId" rowSelection="multiple" :suppressRowClickSelection="true" />
       </div>
     </div>
             ...
             <el-col :span="24">
               <el-form-item label="系统内置" prop="configType">
                 <el-radio-group v-model="form.configType">
                   <el-radio-button v-for="dict in sys_yes_no" :key="dict.value" :label="dict.value">{{ dict.label
                     }}</el-radio-button>
                 </el-radio-group>
               </el-form-item>
             </el-col>
 ...
 const gridAPI = ref("/system/config/list")
       ...
       buttonConfig: [
         {
           label: "修改",
           type: "primary",
           authentication: "system:config:edit",
           fun: 1,
         },
         {
           label: "删除",
           type: "danger",
           fun: 2,
           authentication: "system:config:remove",
         },
       ]
     },
 ...
 function handleBatchDelete() {
   let ids = gridRef.value.HandleGetSelectRow().map(ele => ele.configId)
