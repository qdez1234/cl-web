      ...
      <splitpanes :horizontal="appStore.device === 'mobile'" class="default-theme">
        ...
        <pane size="16">
          <el-col style="height: 100%;">
            ...
            <div class="head-container" style="height: 100%;">
              <el-tree :data="deptOptions" style="height: 100%;" :props="{ label: 'label', children: 'children' }"
        ...
        <pane size="84">
          <el-col style="height: 100%; display: flex;flex-direction: column;">
            ...
            <el-table v-loading="loading" :data="userList" @selection-change="handleSelectionChange" style="flex: 1;">
