  ...
  <div class="container">
    ...
    <div class="grid ag-theme-quartz" ref="agGridRef">
      <ag-grid-vue :class="['aggrid_Root']" @grid-ready="onGridReady" :rowSelection="rowSelection"
        ...
        :localeText="AG_GRID_LOCALE_CN" @rowSelected="HandleSeleChange" @columnMoved="onColumnChanged" :treeData="true"
...
const getDataPath = function (data) {
  ...
  return data.ancestors ? [data.deptName,data.ancestors] : [data.deptName]; // 从ancestors获取路径
}
...
// 中文翻译
import AG_GRID_LOCALE_CN from "./Language/zh-CN.js";
// 操作按钮
