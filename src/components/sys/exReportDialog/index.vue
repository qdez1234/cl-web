<template>
  ...
  <el-dialog v-model="dialogVisible" draggable title="数据查询" :close-on-click-modal="false" width="80%">
    <div class="content">
      <div class="search">
      ...
      <AgTable class="AgTable" :grildParams="queryParams" :grildFixedParams="fixedParams" ref="gridRef"
        ...
        :gridKey="route.path + 'exReportDialog'" :grildUrl="props.source.dataApi" @handleChange="setValue"
